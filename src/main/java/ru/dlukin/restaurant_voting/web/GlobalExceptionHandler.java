...
import ru.dlukin.restaurant_voting.util.exception.AppException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> persistException(WebRequest request, ConstraintViolationException cv) {
        log.error("ConstraintViolationException: {}", cv.getMessage());
        return createResponseEntity(getDefaultBody(request, ErrorAttributeOptions.of(MESSAGE), null), HttpStatus.UNPROCESSABLE_ENTITY);
    }
