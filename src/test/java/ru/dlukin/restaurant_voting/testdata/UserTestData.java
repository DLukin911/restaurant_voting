...
public class UserTestData {
    ...
    public static final User user =
            new User(USER_ID, "User1_Name", "user1@gmail.com", "{noop}password", Role.USER);
    public static final User user2 =
            new User(USER_ID + 1, "User2_Name", "user2@gmail.com", "{noop}password", Role.USER);
    public static final User user3 =
            new User(USER_ID + 2, "User3_Name", "user3@gmail.com", "{noop}password", Role.USER);
    public static final User admin =
            new User(ADMIN_ID, "Admin1_Name", "admin@restaurant.com", "{noop}admin", Role.USER, Role.ADMIN);

    public static final UserTo userTo =
            new UserTo(USER_ID, "UpdatedName", "update@gmail.com", "{noop}newPass");
